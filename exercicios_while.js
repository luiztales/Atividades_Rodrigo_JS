...
// O código abaixo funciona em um navegador. Foi comentado para não travar a execução em outros ambientes.
/*
let senha;
while (senha !== "1234") {
...
//    i++;
// }
console.log("Previsão para o exercício 9: O console exibirá os números 0, 1 e 2, em linhas separadas.");
let j = 0; // Usando 'j' para não conflitar com a variável 'i' do exercício 1
while (j < 3) {
  console.log(j);
  j++;
}
...
console.log("Sorteando números até encontrar o 7...");
